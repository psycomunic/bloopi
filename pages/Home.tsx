        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6 text-center lg:text-left">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 w-fit mx-auto lg:mx-0"
            >
            ...
            <motion.p
              ...
              className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0"
            >
            ...
            >
              ...
              <button className="h-12 px-8 rounded-xl glass text-slate-800 dark:text-slate-200 font-bold text-base hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg transition-all duration-300">
                Falar com Vendas
              </button>
            </motion.div>
            <motion.div
              ...
              className="flex items-center justify-center lg:justify-start gap-4 pt-4 opacity-80"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              className="glass rounded-2xl p-8 flex flex-col gap-4 group hover:-translate-y-1 transition-transform duration-300"
            >
