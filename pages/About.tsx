    ...
    <div className="w-full flex flex-col">
      ...
      <div className="relative w-full py-20 bg-background-light dark:bg-background-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-10 flex flex-col lg:flex-row gap-10 items-center">
          ...
          <div className="flex-1 w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl rotate-1 hover:rotate-0 transition-transform duration-500 relative group">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="glass-panel rounded-xl p-8 hover:-translate-y-1 transition-transform duration-300 border border-white/50 dark:border-slate-700 bg-white/50 dark:bg-slate-800/50">
            ...
            <div className="flex flex-col gap-10">
              {[
                ...
                <div key={idx} className="relative pl-16">
                  ...
                  <div className="glass-panel p-6 rounded-lg border-l-4 border-l-primary bg-white dark:bg-slate-800">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="glass-panel rounded-xl overflow-hidden group hover:shadow-lg transition-all duration-300 bg-white dark:bg-slate-800">
